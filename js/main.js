...
(function () {
  ...
  const EN = {
    ...
    'p.cognify.tag1':'Augmented reality','p.cognify.tag2':'Gamification','p.cognify.tag3':'Microlearning','p.cognify.tag4':'Social learning','p.cognify.status':'In progress','p.forwerts.tag1':'E-commerce','p.forwerts.tag2':'Self-service portals','p.forwerts.tag3':'Design structures',
